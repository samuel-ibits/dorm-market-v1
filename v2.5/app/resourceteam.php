  ...
  if($ppic=="media/"){$ppic="media/ppic/pro.png";
        ...
        <div class="page-content">
            <div class="study-tools-page">
                <a href="textbookupload.php?t=<?php echo$_COOKIE['dormtoken']; ?>" class="study-tool-card">
                    ...
                    <div class="study-tool-info">
                        <p class="study-tool-sub-text">
                            Upload 5 text books</p>
                    </div>

                </a>
                <a href="passedquestionupload.php?t=<?php echo$_COOKIE['dormtoken']; ?>" class="study-tool-card">
                    ...
                    <div class="study-tool-info">
                        <p class="study-tool-sub-text">Upload 10 past questions</p>
                    </div>

                </a>
                <a href="notebookupload.php?t=<?php echo$_COOKIE['dormtoken']; ?>" class="study-tool-card">
                    ...
                    <div class="study-tool-info">
                        <p class="study-tool-sub-text">Upload 5 lecturer notes</p>
                    </div>

                </a>
                <a href="coursereviewupload.php?t=<?php echo$_COOKIE['dormtoken']; ?>" class="study-tool-card">
                    ...
                    <div class="study-tool-info">
                        <p class="study-tool-sub-text">Give a coursereview on your best and worst courses so far and send us screenshots.</p>
                    </div>
        ...
        <div class="page-side">
            ...
            <div class="blue-area-2">
                ...
                <div class="bottom-side-list">
                    <ul class="smaller">
                        <a href="profile.php?t=<?php echo$_COOKIE['dormtoken']; ?>">
                            <li class="menu-item">
                        ...
                        <a href="wallet.php?t=<?php echo$_COOKIE['dormtoken']; ?>">
                            <li class="menu-item">
                                <div class="icon-img-small-icon">
                        ...
                        <a href="manageproduct.php?t=<?php echo$_COOKIE['dormtoken']; ?>">
                            <li class="menu-item">
                                <div class="icon-img-small-icon">
                        ...
                        <a href="marketdashboard.php?t=<?php echo$_COOKIE['dormtoken']; ?>">
                            <li class="menu-item">
                                <div class="icon-img-small-icon">
                        ...
                        <a href="accomodiadashboard.php?t=<?php echo$_COOKIE['dormtoken']; ?>">
                            <li class="menu-item">
                                <div class="icon-img-small-icon">
                                    <ion-icon name="speedometer"></ion-icon>
                                </div>
                        ...
                        <a href="resourceteam.php?t=<?php echo$_COOKIE['dormtoken']; ?>">
                        ...
                        <a href="feedback.php?t=<?php echo$_COOKIE['dormtoken']; ?>">
                            <li class="menu-item">
                                <div class="icon-img-small-icon">
