...
<body>
    ...
    <div class="note-uploader">
        <div class="note-box">
           <span class="box-text"> <ion-icon name="cloud-upload"></ion-icon> Upload a Note</span>
            <input type="file" name="" id="">
        </div>
        <div class="note-box">
            <span class="box-text"><ion-icon name="add"></ion-icon> New note</span>
  ...
  if($ppic=="media/"){$ppic="media/ppic/pro.png";
        ...
        <div class="page-content">
            <div class="my-notes-page">
                <div class="page-title"><i class="bi bi-link"></i> My Notes</div>

                <div class="note-card-holder">
                    <div class="note-card">
                        <div class="image-icon">
                            <img src="images/paper-img.png" alt="">
                        </div>
                        <div class="note-card-info">
                            <p class="name-of-note">CSC (101 intro to csc)</p>
                        </div>
                    </div>
                    <div class="note-card">
                        <div class="image-icon">
        ...
        <div class="page-side">
            ...
            <div class="double-section">
                ...
                <div class="text-icon">
                    <div class="icon"><img src="images/Icon material-cloud-upload.png" alt=""></div>
                    <p class="double-section-text">Upload a note</p>
                </div>
            </div>
