        ...
        <div class="study-tool-tool">
            <ul class="tool-icon-holder">
                <ul class="tool-icon-holder">
                    ...
                    <li class="active-tool-icon tool-icon"><a href="noteweb.php?t=<?php echo$t; ?>"><img src="images/upload.png" alt=""></a></li>
        ...
        <div class="page-content">
            <div class="noteweb-page">
                ...
                <div class="noteweb-box">
                    ...
                    <button class="big-orange-2" name="go">SEARCH</button>
                    </form >
                   <a href="mynotes.php?t=<?php echo$t; ?>"> <p class="unserlined-blue">Publish a note</p></a>
                </div>
