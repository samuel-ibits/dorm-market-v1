...
While ($row=$result->fetch_assoc()){
  ...
  if($ppic=="media/"){$ppic="media/ppic/pro.png";
        ...
        <div class="page-content">
            ...
            <a href="notebook.php?t=<?php echo$t; ?>" class="study-tool-card">
               ...
               <a href="noteweb.php?t=<?php echo$t; ?>" class="study-tool-card">
               ...
               <a href="gpcalc.php?t=<?php echo$t; ?>" class="study-tool-card">
               ...
               <a href="library.php?t=<?php echo$t; ?>" class="study-tool-card">
               ...
               <a href="cbt.php?t=<?php echo$t; ?>" class="study-tool-card">
