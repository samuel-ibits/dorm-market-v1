...
<label for="ppi"  >
                            ...
                            <div class="center-button" style="gap: .5rem;">
                                <button onclick="editname()" class="submit"><i class="bi bi-pencil-square"></i>
                                    Edit</button>
                               <form method="post" action="" enctype="multipart/form-data">
                                <button class="submit" name="save"><i class="bi bi-download" ></i> Save
                                    changes</button>
                            </div>
                        </div>
                    </div>
 <input type="file" name="ppi" id="ppi" style="display:none;" />
