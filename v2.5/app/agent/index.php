...
$_SESSION['dormuserid']="$f";
 ...
 $iiin = "INSERT INTO login (id, userid, date, page) VALUES ( '', '$f', '$date', 'accomodialogin username')";
...
//  header('Location: https://dorm.com.ng/v2.5/app/accomodiadashboard.php?t='.$tokensess);

echo'
 <script> window.location.href ="https://dorm.com.ng/v2.5/app/accomodiadashboard.php?t='.$tokensess.'"; </script>
';
